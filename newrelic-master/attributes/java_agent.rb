...
default['newrelic']['java_agent']['version'] = '3.29.0'
default['newrelic']['java_agent']['install_dir'] = '/srv/glassfish4/'
default['newrelic']['java_agent']['app_user'] = 'ec2-user'
default['newrelic']['java_agent']['app_group'] = 'ec2-user'
